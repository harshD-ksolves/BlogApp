  ...
  return (
    <div className="single">
      <div className="content">
        ...
        <span className="tags">
          <span className='tag'>SEO</span> <span className="tag">new Topic</span> <span className="tag">Bold</span>  <span className="tag">Technological</span> <span className="tag">Computer Science</span>
        </span>
        <p>
          <p>
